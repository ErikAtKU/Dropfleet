...
implement shaltariOnyx inherits shipClass

constants
    nameList : string* = [].
    shipStats_var : shipStats = shaltariStats(165, 12.0, sig(3.0, 16.0), 8.0, 11, arm(d6(5, p), d6(4, p)), 9, g(1, 1), heavy).
...
class facts
    ...
    weaponSystemList : weaponSystem* :=
        [
            weaponSystem("Disintegrator Battery", d6(3, p), i(4), i(1), [front()], []),
