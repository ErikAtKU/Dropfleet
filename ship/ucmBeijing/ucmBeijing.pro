...
implement ucmBeijing inherits shipClass

constants
    nameList : string* = [].
    shipStats_var : shipStats = stats(232, 8.0, 12.0, 6.0, 18, d6(3, p), 10, g(1, 1), superHeavy(1)).
...
class facts
    ...
    weaponSystemList : weaponSystem* :=
        [
            ...
            weaponSystem("UF-6400 Mass Driver Turrets", d6(3, p), i(6), i(1), [front(), side()], [linked(1)]),
