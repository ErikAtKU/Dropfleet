...
implement scourgeWraith inherits shipClass

constants
    nameList : string* = [].
    shipStats_var : shipStats = stats(40, 6.0, 6.0, 16.0, 6, d6(5, p), 2, g(2, 3), light(2)).
...
class facts
    ...
    weaponSystemList : weaponSystem* :=
        [
            ...
            weaponSystem("Plasma Brand", d6(4, p), i(2), i(2), [front()], [closeAction(beam)])
        ].
