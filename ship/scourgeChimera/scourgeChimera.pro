...
implement scourgeChimera inherits shipClass

constants
    nameList : string* = [].
    shipStats_var : shipStats = stats(105, 6.0, 8.0, 10.0, 10, d6(4, p), 6, g(1, 1), medium).
...
class facts
    ...
    weaponSystemList : weaponSystem* :=
        [
            weaponSystem("Oculus Beams", d6(3, p), i(1), i(2), [front(), side()], [scald]),
