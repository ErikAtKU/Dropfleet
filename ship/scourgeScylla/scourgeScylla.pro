...
implement scourgeScylla inherits shipClass

constants
    nameList : string* = [].
    shipStats_var : shipStats = stats(42, 6.0, 3.0, 12.0, 4, d6(5, p), 4, g(2, 4), light(1)).
...
class facts
    ...
    weaponSystemList : weaponSystem* :=
        [
            ...
            weaponSystem("Reverse-Grav Cannon", d6(3, p), i(2), i(1), [front(), side()], [escapeVelocity]),
