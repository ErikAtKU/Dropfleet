...
implement shaltariTopaz inherits shipClass

constants
    nameList : string* = [].
    shipStats_var : shipStats = shaltariStats(37, 12.0, sig(2.0, 12.0), 12.0, 4, arm(d6(5, p), d6(4, p)), 6, g(2, 4), light(1)).
...
class facts
    ...
    weaponSystemList : weaponSystem* :=
        [
            weaponSystem("Disintergrator Bank", d6(3, p), i(2), i(1), [front()], []),
