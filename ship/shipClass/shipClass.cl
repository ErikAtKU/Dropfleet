...
predicates
    getFleetBuilderStats : (string ClassName, shipStats, shipSpecial*, weaponSystem*, core::function{ship} Constructor) -> fleetBuilderStats.
...
predicates
    getFBSDesc : (fleetBuilderStats, string Desc [out]).
