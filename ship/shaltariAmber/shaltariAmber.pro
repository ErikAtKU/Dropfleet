...
implement shaltariAmber inherits shipClass

constants
    nameList : string* = [].
    shipStats_var : shipStats = shaltariStats(110, 12.0, sig(3.0, 16.0), 10.0, 9, arm(d6(5, p), d6(4, p)), 9, g(1, 2), medium).
