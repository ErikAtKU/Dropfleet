...
implement shaltariAdamant inherits shipClass
...
class facts
    ...
    weaponSystemList : weaponSystem* :=
        [
            ...
            weaponSystem("Particle Lance Pair", d6(3, p), i(2), i(2), [front(narrow)], [particle, fusillade(2)]),
