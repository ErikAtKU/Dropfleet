...
implement ucmNewYork inherits shipClass

constants
    nameList : string* = [].
    shipStats_var : shipStats = stats(250, 8.0, 12.0, 6.0, 18, d6(3, p), 10, g(1, 1), superHeavy(1)).
    special_var : shipSpecial* = [launch(launchAssets)].
    launchAssets : launchSystem* = [strikeCraft(ucmFightersBombers, 7, []), torpedo(ucmTorpedoes, 1, [limited(2)])].
