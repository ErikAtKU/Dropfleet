...
implement ucmVenice inherits shipClass

constants
    nameList : string* = [].
    shipStats_var : shipStats = stats(220, 6.0, 6.0, 8.0, 14, d6(3, p), 7, g(1, 1), heavy).
    special_var : shipSpecial* = [venice_stat].
