...
implement ucmStPetersburg inherits shipClass

constants
    nameList : string* = [].
    shipStats_var : shipStats = stats(140, 6.0, 6.0, 7.0, 12, d6(3, p), 5, g(1, 1), heavy).
...
class facts
    ...
    weaponSystemList : weaponSystem* :=
        [
            ...
            weaponSystem("Cobra Heavy Laser", d6(3, p), i(2), i(1), [front(narrow)], [burnthrough(6), flash, siphonPower]),
            weaponSystem("Cobra Heavy Laser", d6(3, p), i(2), i(1), [front(narrow)], [burnthrough(6), flash, siphonPower]),
