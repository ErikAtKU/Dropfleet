...
implement ucmJakarta inherits shipClass

constants
    nameList : string* = [].
    shipStats_var : shipStats = stats(32, 6.0, 3.0, 10.0, 4, d6(4, p), 3, g(1, 4), light(1)).
    special_var : shipSpecial* = [aegis(6)].
